...
nagraj_ekran()
{
	echo " Podaj nazwe pliku koncowego nagrania. np. dowody_na_kapcia.mp4 "
	read file_name
...
{	
	echo " Podaj sciezke do zaladowania pliku wav. ex /home/kali/Desktop/fiut.wav"
	read sciezka
	echo "Podaj nazwe pliku ex. fiut.wav"
	read nazwa_pliku 
...
figlet urPhone
echo "Nikt i nic sie przed nami nie ukryje."

echo "|---------------------------------|"
echo "| Stworzono przez IkigaiHack|"
echo "| urPhone, wersja 1.0           |"
